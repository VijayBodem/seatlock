...
export type StorageHash =
  StorageHashBase<'0740bd0e79561a6426605e3f020921855af010ab204a57aefc8c2f80b7b55efc'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Payment: {
      ...
      readonly refundRequestedAt: CodecTypes['pg/timestamptz-string@1']['output'] | null;
      readonly refundedAt: CodecTypes['pg/timestamptz-string@1']['output'] | null;
      readonly refundFailedAt: CodecTypes['pg/timestamptz-string@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Payment: {
      ...
      readonly refundRequestedAt: CodecTypes['pg/timestamptz-string@1']['input'] | null;
      readonly refundedAt: CodecTypes['pg/timestamptz-string@1']['input'] | null;
      readonly refundFailedAt: CodecTypes['pg/timestamptz-string@1']['input'] | null;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly outboxEvent: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'outboxEvent_nextAttemptAt_idx_34b4e877';
                  readonly prefix: 'outboxEvent_nextAttemptAt_idx';
                  readonly columns: readonly ['nextAttemptAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'outboxEvent_claimedAt_idx_622598dc';
                  readonly prefix: 'outboxEvent_claimedAt_idx';
                  readonly columns: readonly ['claimedAt'];
                  readonly unique: false;
                },
                {
            ...
            readonly showtimeSeat: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['showtimeId', 'seatId'] }];
              indexes: readonly [
                {
          ...
          readonly valueSet: {
            ...
            readonly SeatHoldStatus: {
              readonly kind: 'valueSet';
              readonly values: readonly ['ACTIVE', 'COMPLETED', 'EXPIRED', 'CANCELLED'];
            };
            readonly SeatType: {
              readonly kind: 'valueSet';
          ...
          readonly Payment: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly refundRequestedAt: { readonly column: 'refundRequestedAt' };
                readonly refundedAt: { readonly column: 'refundedAt' };
                readonly refundFailedAt: { readonly column: 'refundFailedAt' };
                readonly refundFailureReason: { readonly column: 'refundFailureReason' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
        ...
        readonly enum: {
          ...
          readonly PaymentStatus: {
            ...
            readonly members: readonly [
              ...
              { readonly name: 'REFUND_PENDING'; readonly value: 'REFUND_PENDING' },
              { readonly name: 'REFUNDED'; readonly value: 'REFUNDED' },
              { readonly name: 'REFUND_FAILED'; readonly value: 'REFUND_FAILED' },
